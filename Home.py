...
#合肥水泥院简介
st.write("<h5 style='color: black; text-indent:2em; line-height:20px; '>合肥水泥研究设计院有限公司是世界财富500强企业——中国建材集\
...
with col1:
    ...
    st.write("<h5 style='color: blue; text-align:center'>公司平台</h5>",unsafe_allow_html=True)
...
with col2:
    ...
    st.write("<h5 style='color: blue; text-align:center'>HFGG系列高性能辊压机</h5>",unsafe_allow_html=True)

with col3:
    img3 = mpimg.imread(r'./pages/images/HP强涡流型多风道煤粉燃烧器.png')
    st.image(img3,caption='') 
    st.write("<h5 style='color: blue; text-align:center'>HP强涡流型多风道煤粉燃烧器</h5>",unsafe_allow_html=True)
