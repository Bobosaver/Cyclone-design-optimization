...
if choose_func == op_func[0]:
    ...
    with col1:
        img1 = mpimg.imread(r'./pages/Ball_mill_images/密度倍数.png')
        st.image(img1)
    ...
    with col2:
        img2 = mpimg.imread(r'./pages/Ball_mill_images/球_料恢复系数.png')
        st.image(img2)
    ...
    with col3:
        img3 = mpimg.imread(r'./pages/Ball_mill_images/球_球恢复系数.png')
        st.image(img3)  
    ...
    with col4:
        img4 = mpimg.imread(r'./pages/Ball_mill_images/球_料摩擦系数.png')
        st.image(img4)  
    ...
    with col5:
        img5 = mpimg.imread(r'./pages/Ball_mill_images/球_球摩擦系数.png')
        st.image(img5)  
    ...
    with col6:
        img6 = mpimg.imread(r'./pages/Ball_mill_images/模量倍数.png')
        st.image(img6)  
